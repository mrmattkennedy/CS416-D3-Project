!function(t, e) {
    "object" == typeof exports && "undefined" != typeof module ? e(exports, require("d3-selection"), require("d3-drag"), require("d3-shape"), require("d3-dispatch")) : "function" == typeof define && define.amd ? define(["exports", "d3-selection", "d3-drag", "d3-shape", "d3-dispatch"], e) : e(t.d3 = t.d3 || {}, t.d3, t.d3, t.d3, t.d3)
}(this, function(t, e, n, o, a) {
    "use strict";
    function i() {
        var t = []
          , n = void 0
          ...
          , g = function(o) {
            v = o,
            c || o.selectAll("circle.handle").remove();
            var a = t.map(function(t) {
                return t.type || (t.type = u),
                t.disable || (t.disable = i),
                new y(t)
            });
            n = n || new f({
                annotations: a,
            ...
            U(g, n.annotations, "g", "annotation"),
            g.selectAll("g.annotation").each(function(t) {
                var n = e.select(this);
                n.attr("class", "annotation"),
                U(n, [t], "g", "annotation-connector"),
                U(n, [t], "g", "annotation-subject"),
                U(n, [t], "g", "annotation-note"),
                U(n.select("g.annotation-note"), [t], "g", "annotation-note-content"),
                t.type = "[object Object]" === t.type.toString() ? t.type : new t.type({
                    a: n,
                    annotation: t,
                    textWrap: h,
                    notePadding: l,
                ...
                t.type.draw(),
                t.type.drawText && t.type.drawText()
            })
        };
        return g.json = function() {
            return console.log("Annotations JSON was copied to your clipboard. Please note the annotation type is not JSON compatible. It appears in the objects array in the console, but not in the copied JSON.", n.json),
            window.copy(JSON.stringify(n.json.map(function(t) {
        ...
        g.updateText = function() {
            return n && (n.updateText(h),
            t = n.annotations),
            g
        }
        ,
        g.updatedAccessors = function() {
            return n.setPositionWithAccessors(),
            t = n.annotations,
            g
        }
        ,
        ...
        g.type = function(e, o) {
            ...
            n && (n.annotations.map(function(t) {
                t.type.note && t.type.note.selectAll("*:not(.annotation-note-content)").remove(),
                t.type.noteContent && t.type.noteContent.selectAll("*").remove(),
                t.type.subject && t.type.subject.selectAll("*").remove(),
                t.type.connector && t.type.connector.selectAll("*").remove(),
                t.type.typeSettings = {},
                t.type = u,
                t.subject = o && o.subject || t.subject,
                t.connector = o && o.connector || t.connector,
                t.note = o && o.note || t.note
            }),
            t = n.annotations),
            g) : u
        }
        ...
        g.editMode = function(e) {
            ...
            v && v.selectAll("g.annotation").classed("editable", c),
            n && (n.editMode(c),
            t = n.annotations),
            g) : c
        }
    ...
    : function(t) {
      ...
      , y = function() {
        function t(e) {
            var n = e.x
              ...
              , w = e.className;
            r(this, t),
            this._dx = void 0 !== s ? s - o : l,
            this._dy = void 0 !== c ? c - i : u,
            this._x = o,
            this._y = i,
            this._color = y,
            this.id = j,
        ...
        return c(t, [{
            key: "updatePosition",
            value: function() {
                this.type.setPosition && (this.type.setPosition(),
                this.type.subject && 0 !== this.type.subject.selectAll(":not(.handle)").nodes().length && this.type.redrawSubject())
            }
        }, {
            key: "clearComponents",
            value: function() {
            ...
            key: "updateOffset",
            value: function() {
                this.type.setOffset && (this.type.setOffset(),
                0 !== this.type.connector.selectAll(":not(.handle)").nodes().length && this.type.redrawConnector(),
            ...
            set: function(t) {
                this._className = t,
                this.type.setClassName && this.type.setClassName()
            }
        }, {
            key: "type",
            get: function() {
            ...
            get: function() {
                ...
                return this.data && Object.keys(this.data).length > 0 && (t.data = this.data),
                this.type && (t.type = this.type),
                this._className && (t.className = this._className),
                Object.keys(this.connector).length > 0 && (t.connector = this.connector),
                Object.keys(this.subject).length > 0 && (t.subject = this.subject),
                Object.keys(this.note).length > 0 && (t.note = this.note),
                t
            }
        }]),
        t
        ...
        return c(t, [{
            ...
            value: function(t) {
                this.annotations.forEach(function(e) {
                    e.type = void 0,
                    e.subject = t && t.subject || e.subject,
                    e.connector = t && t.connector || e.connector,
                    e.note = t && t.note || e.note
                })
            }
        }, {
            ...
            value: function(t) {
                this.annotations.forEach(function(e) {
                    e.type && (e.type.editMode = t,
                    e.type.updateEditMode())
                })
            }
        }, {
            key: "updateDisable",
            value: function(t) {
                this.annotations.forEach(function(e) {
                    ...
                    e.type && t.forEach(function(t) {
                        e.type[t] && (e.type[t].remove && e.type[t].remove(),
                        e.type[t] = void 0)
                    })
                })
            }
            ...
            get: function() {
                ...
                return this.annotations.map(function(e) {
                    var n = e.json;
                    return t.accessorsInverse && e.data && (n.data = {},
                    Object.keys(t.accessorsInverse).forEach(function(o) {
      ...
      , x = function(t, e) {
        return "dynamic" !== t && "left" !== t && "right" !== t || (t = e < 0 ? "top" : "bottom"),
        t
    }
      , m = function(t, e) {
        return "dynamic" !== t && "top" !== t && "bottom" !== t || (t = e < 0 ? "right" : "left"),
        t
    }
      ...
      , _ = function(t) {
        var e = t.padding
          ...
          , d = -a.x
          , u = 0;
        return j.indexOf(s) !== -1 ? (i = m(i, c.x),
        c.y < 0 && "topBottom" === s || "top" === s ? u -= a.height + n : u += n,
        "middle" === i ? d -= a.width / 2 : "right" === i && (d -= a.width)) : w.indexOf(s) !== -1 && (i = x(i, c.y),
        c.x < 0 && "leftRight" === s || "left" === s ? d -= a.width + n : d += n,
        "middle" === i ? u -= a.height / 2 : "top" === i && (u -= a.height)),
        {
            x: d,
            y: u
        }
      ...
      , O = function(t) {
        ...
        return n ? (r.context(n),
        s.pathMethods = lineGen) : s.attrs = {
            d: r()
        },
        s
    }
      , N = function(t) {
        var e = t.align
          ...
          , i = void 0 === a ? 0 : a
          , s = t.bbox;
        return e = x(e, t.offset.y),
        "top" === e ? i -= s.height : "middle" === e && (i -= s.height / 2),
        {
            components: [k({
      ...
      , M = function(t) {
        var e = t.align
          ...
          , r = t.bbox;
        return e = m(e, s.x),
        "right" === e ? o -= r.width : "middle" === e && (o -= r.width / 2),
        {
            components: [k({
      ...
      , S = function(t) {
        ...
        if ("circle" === n && (d.outerRadius || d.radius)) {
            ...
            i = Math.abs(Math.cos(h) * l) * (s < 0 ? -1 : 1),
            r = Math.abs(Math.sin(h) * l) * (c < 0 ? -1 : 1)
        }
        if ("rect" === n) {
            var p = d.width
              , y = d.height;
            (p > 0 && o.dx > 0 || p < 0 && o.dx < 0) && (i = Math.abs(p) > Math.abs(o.dx) ? p / 2 : p),
            (y > 0 && o.dy > 0 || y < 0 && o.dy < 0) && (r = Math.abs(y) > Math.abs(o.dy) ? y / 2 : y),
            i === p / 2 && r === y / 2 && (i = s,
            r = c)
        }
        return [[i, r], [s, c]]
      ...
      , P = function(t) {
        ...
        if ("rect" === n) {
            var u = d.width
              , h = d.height;
            (u > 0 && o.dx > 0 || u < 0 && o.dx < 0) && (i = Math.abs(u) > Math.abs(o.dx) ? u / 2 : u),
            (h > 0 && o.dy > 0 || h < 0 && o.dy < 0) && (r = Math.abs(h) > Math.abs(o.dy) ? h / 2 : h),
            i === u / 2 && r === h / 2 && (i = s,
            r = c)
        }
        var l = [[i, r], [s, c]]
        ...
        if (Math.abs(y) < Math.abs(p) ? (f = s,
        v = r + y * g) : (v = c,
        f = i + p * g),
        "circle" === n && (d.outerRadius || d.radius)) {
            var b = (d.outerRadius || d.radius) + (d.radiusPadding || 0)
              , x = b / Math.sqrt(2);
            if (Math.abs(y) > x && Math.abs(p) > x)
                i = x * (s < 0 ? -1 : 1),
                r = x * (c < 0 ? -1 : 1),
                l = [[i, r], [f, v], [s, c]];
            else if (Math.abs(y) > Math.abs(p)) {
                var m = Math.asin(-c / b);
                i = Math.abs(Math.cos(m) * b) * (s < 0 ? -1 : 1),
                l = [[i, c], [s, c]]
            } else {
                var j = Math.acos(s / b);
                r = Math.abs(Math.sin(j) * b) * (c < 0 ? -1 : 1),
                l = [[s, r], [s, c]]
            }
        } else
            l = [[i, r], [f, v], [s, c]];
      ...
      , T = function(t) {
        var n = t.type
          ...
          , i = t.subjectType;
        a || (a = {}),
        a.points && "number" != typeof a.points || (a.points = A(n.annotation.offset, a.points)),
        a.curve || (a.curve = o.curveCatmullRom);
        var s = [];
        if (n.editMode) {
            var r = a.points.map(function(t, e) {
              ...
              , c = function(t) {
                a.points[t][0] += e.event.dx,
                a.points[t][1] += e.event.dy,
                n.redrawConnector()
            };
      ...
      , A = function(t) {
        for (var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 2, n = {
            ...
            o.push([n.x * a + a % 2 * 20, n.y * a - a % 2 * 20]);
        return o
    }
      , E = function(t) {
        var e = t.annotation
      ...
      , D = function(t) {
        ...
        o.radius || (r && r.radius ? o.radius = r.radius : o.radius = 14),
        o.x || r && r.x && (o.x = r.x),
        o.y || r && r.y && (o.y = r.y);
        var c = []
          , d = []
        ...
        o.x && !o.y ? l = f["x" + o.x] : o.y && !o.x ? p = f["y" + o.y] : o.x && o.y && (l = f["x" + o.x + "corner"],
        p = f["y" + o.y + "corner"]);
        var v = "translate(" + l + ", " + p + ")"
          , g = O({
            className: "subject",
        ...
        g.attrs.transform = v,
        g.attrs.fill = s.color,
        g.attrs["stroke-linecap"] = "round",
        g.attrs["stroke-width"] = "3px";
        var b = O({
        ...
        if (x && (x.attrs.fill = s.color,
        x.attrs["stroke-linecap"] = "round",
        x.attrs["stroke-width"] = "3px",
        d.push(x)),
        i.editMode) {
            var j = function() {
                o.x = e.event.x < 2 * -u ? "left" : e.event.x > 2 * u ? "right" : void 0,
                o.y = e.event.y < 2 * -u ? "top" : e.event.y > 2 * u ? "bottom" : void 0,
                i.redrawSubject()
            }
              , w = {
                x: 2 * l,
      ...
      , W = function() {
        function t(e) {
            ...
            if (r(this, t),
            this.a = n,
            this.note = o.disable.indexOf("note") === -1 && n.select("g.annotation-note"),
            this.noteContent = this.note && n.select("g.annotation-note-content"),
            this.connector = o.disable.indexOf("connector") === -1 && n.select("g.annotation-connector"),
            this.subject = o.disable.indexOf("subject") === -1 && n.select("g.annotation-subject"),
            this.dispatcher = i,
            i) {
            ...
            this.annotation = o,
            this.editMode = o.editMode || a,
            this.notePadding = void 0 !== s ? s : 3,
            this.offsetCornerX = 0,
            this.offsetCornerY = 0,
            c && o.data && this.init(c)
        }
        return c(t, [{
            key: "init",
            value: function(t) {
                this.annotation.x || this.mapX(t),
                this.annotation.y || this.mapY(t)
            }
        }, {
            key: "mapY",
            value: function(t) {
            ...
            value: function() {
                ...
                return t.offsetCornerX = parseFloat(e[1]) + this.annotation.dx,
                t.offsetCornerY = parseFloat(e[2]) + this.annotation.dy,
                t.offsetX = this.annotation.dx,
                t.offsetY = this.annotation.dy,
                t
            }
        }, {
            key: "drawSubject",
            ...
            value: function() {
                ...
                var s = i
                  ...
                  , u = void 0 === d ? [] : d
                  , h = c[0];
                h && (h.attrs.stroke = this.annotation.color,
                h.attrs.fill = "none");
                var l = n.end || e.end
                  , p = {};
                if ("arrow" === l) {
                    var y = h.data[1]
                      , f = h.data[0];
                    Math.sqrt(Math.pow(y[0] - f[0], 2) + Math.pow(y[1] - f[1], 2)) < 5 && h.data[2] && (y = h.data[2]),
                    p = E({
                ...
                return p.components && (p.components.forEach(function(e) {
                    e.attrs.fill = t.annotation.color,
                    e.attrs.stroke = t.annotation.color
                }),
                c = c.concat(p.components)),
                this.editMode && 0 !== u.length && c.push({
                    type: "handle",
                    handles: u
                }),
                c
            ...
            value: function(t) {
                ...
                var s = {
                  ...
                  , c = r.x
                  , d = r.y;
                return this.offsetCornerX = c + this.annotation.dx,
                this.offsetCornerY = d + this.annotation.dy,
                this.note && this.noteContent.attr("transform", "translate(" + c + ", " + d + ")"),
                []
            }
        }, {
            key: "drawOnScreen",
            ...
            key: "setPositionWithAccessors",
            value: function(t) {
                t && this.annotation.data && (this.mapX(t),
                this.mapY(t)),
                this.setPosition()
            }
        }, {
      ...
      , X = function(t, e, n) {
        return function(t) {
            function o(t) {
                ...
                return n.typeSettings = e,
                e.disable && e.disable.forEach(function(t) {
                    n[t] && n[t].remove(),
                    n[t] = void 0,
                    "note" === t && (n.noteContent = void 0)
                }),
                n
            }
            return h(o, t),
            c(o, [{
                ...
                key: "drawSubject",
                value: function(t) {
                    return this.typeSettings.subject = d({}, e.subject, this.typeSettings.subject),
                    u(o.prototype.__proto__ || Object.getPrototypeOf(o.prototype), "drawSubject", this).call(this, d({}, t, this.typeSettings.subject))
                }
            }, {
                key: "drawConnector",
                value: function(t) {
                    return this.typeSettings.connector = d({}, e.connector, this.typeSettings.connector),
                    u(o.prototype.__proto__ || Object.getPrototypeOf(o.prototype), "drawConnector", this).call(this, d({}, t, e.connector, this.typeSettings.connector))
                }
            }, {
                key: "drawNote",
                value: function(t) {
                    return this.typeSettings.note = d({}, e.note, this.typeSettings.note),
                    u(o.prototype.__proto__ || Object.getPrototypeOf(o.prototype), "drawNote", this).call(this, d({}, t, e.note, this.typeSettings.note))
                }
            }, {
                key: "drawNoteContent",
                value: function(t) {
                ...
                key: "init",
                value: function(t, e) {
                    return u(o.__proto__ || Object.getPrototypeOf(o), "init", this).call(this, t, e),
                    n && (t = n(t, e)),
                    t
                }
            }]),
      ...
      , Y = function(t) {
        function e(t) {
            ...
            return n.textWrap = t.textWrap || 120,
            n.drawText(),
            n
        }
        return h(e, t),
        c(e, [{
            ...
            value: function() {
                if (this.note) {
                    ...
                    U(t, [this.annotation], "rect", "annotation-note-bg"),
                    U(t, [this.annotation], "text", "annotation-note-label"),
                    U(t, [this.annotation], "text", "annotation-note-title");
                    var e = {
                        height: 0
                    }
                    ...
                    if ("number" == typeof i ? r = {
                        ...
                        left: i,
                        right: i
                    } : i && "object" === (void 0 === i ? "undefined" : s(i)) && (r = d(r, i)),
                    this.annotation.note.title) {
                        var c = this.a.select("text.annotation-note-title");
                        c.text(this.annotation.note.title),
                        c.attr("fill", this.annotation.color),
                        c.attr("font-weight", "bold"),
                        c.call($, o, a),
                        e = c.node().getBBox()
                    }
                    n.text(this.annotation.note.label).attr("dx", "0"),
                    n.call($, o, a),
                    n.attr("y", 1.1 * e.height || 0),
                    n.attr("fill", this.annotation.color);
      ...
      , K = function(t) {
        ...
        c(e, [{
            ...
            value: function(t) {
                ...
                (n.subject.x1 || n.subject.x2) && n.data && t.y && (n.y = t.y(n.data)),
                !n.subject.x1 && !n.subject.x2 || n.x || (n.x = n.subject.x1 || n.subject.x2)
            }
        }, {
            key: "mapX",
            value: function(t) {
                ...
                var n = this.annotation;
                (n.subject.y1 || n.subject.y2) && n.data && t.x && (n.x = t.x(n.data)),
                !n.subject.y1 && !n.subject.y2 || n.y || (n.y = n.subject.y1 || n.subject.y2)
            }
        }]),
        e
    }(z)
      ...
      , U = function(t, e, n, o, a) {
        ...
        return i.enter().append(n).merge(i).attr("class", o),
        i.exit().remove(),
        t
    }
      , Z = function(t, e, n) {
      ...
      , $ = function(t, n, o) {
        ...
        t.each(function() {
            for (var t = e.select(this), i = t.text().split(o || /[ \t\r\n]+/).reverse().filter(function(t) {
                return "" !== t
            }), s = void 0, r = [], c = t.text(null).append("tspan").attr("x", 0).attr("dy", "0.8em"); s = i.pop(); )
                r.push(s),
                c.text(r.join(" ")),
                c.node().getComputedTextLength() > n && r.length > 1 && (r.pop(),
                c.text(r.join(" ")),
                r = [s],
                c = t.append("tspan").attr("x", 0).attr("dy", a + "em").text(s))
        })
    }
      , tt = function(t) {
        ...
        return t ? t.selectAll(e).nodes().reduce(function(t, e) {
            ...
            return t.height = Math.max(t.height, (o && parseFloat(o.value) || 0) + n.height),
            t
        }, {
            x: 0,
            y: 0,
    ...
    t.annotation = i,
    t.annotationTypeBase = W,
    t.annotationLabel = H,
    t.annotationCallout = z,
    t.annotationCalloutCurve = J,
    t.annotationCalloutElbow = F,
    t.annotationCalloutCircle = G,
    t.annotationCalloutRect = V,
    t.annotationXYThreshold = Q,
    t.annotationBadge = L,
    t.annotationCustomType = X,
    t.default = et,
